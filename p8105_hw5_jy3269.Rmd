...
1. When the effect size is small(less than 4), the sample average of mu hat when the null is rejected is very different from the true value of mu. It is always larger than the true value of mu(overall sample average of mu hat). 

2. When the effect size gets larger(larger or equal to 4), the sample average of mu hat when the null is rejected is approximately equal to the true value of mu. That’s because as the power is increasing.
